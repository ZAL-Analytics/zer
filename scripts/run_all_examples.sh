...
if ! $LIST_ONLY && [[ ! -f "$REPO_ROOT/data/v1.1/examples/brp_q1/brp_persons.csv" ]]; then
    printf "${C_FAIL}error: example datasets not found (data/v1.1/examples/ is missing or empty).${C_RESET}\n" >&2

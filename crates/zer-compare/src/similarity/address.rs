...
mod tests {
    ...
    fn address_token_overlap_exact() {
        ...
        assert_eq!(
            sim.similarity(&tv("Coolsingel 93"), &tv("Coolsingel 93")),
            1.0
        );
    }
    ...
    fn address_token_overlap_abbreviation() {
        ...
        assert!(
            s > 0.0,
            "abbreviation expansion should yield some overlap, got {s}"
        );
    }
    ...
    fn address_token_overlap_different() {
        ...
        assert!(
            s < 0.3,
            "completely different addresses should be low, got {s}"
        );
    }
    ...
    fn street_number_exact() {
        ...
        assert_eq!(
            sim.similarity(&tv("239 bis Amsterdamseweg"), &tv("239 bis")),
            1.0
        );
    }
    ...
    fn street_number_off_by_one() {
        ...
        assert_eq!(
            sim.similarity(&tv("10 Coolsingel"), &tv("11 Coolsingel")),
            0.8
        );
    }

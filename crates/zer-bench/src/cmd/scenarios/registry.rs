...
pub static ALL_SCENARIOS: &[ScenarioSpec] = &[
    ...
    ScenarioSpec {
        ...
        sources:        &[SourceSpec { path: "data/benchmarks/brp/dedupe/source.csv", source: "brp" }],
        ground_truth:   "data/benchmarks/brp/dedupe/ground_truth.csv",
    ...
    ScenarioSpec {
        ...
        sources:        &[
            SourceSpec { path: "data/benchmarks/brp/link/source_a.csv", source: "brp_a" },
            SourceSpec { path: "data/benchmarks/brp/link/source_b.csv", source: "brp_b" },
        ],
        ground_truth:   "data/benchmarks/brp/link/ground_truth.csv",
    ...
    ScenarioSpec {
        ...
        sources:        &[
            SourceSpec { path: "data/benchmarks/brp/link_and_dedupe/source_a.csv", source: "brp_a" },
            SourceSpec { path: "data/benchmarks/brp/link_and_dedupe/source_b.csv", source: "brp_b" },
        ],
        ground_truth:   "data/benchmarks/brp/link_and_dedupe/ground_truth.csv",
    ...
    ScenarioSpec {
        ...
        ground_truth:   "data/benchmarks/brp_kvk/link/ground_truth.csv",
        mode:           LinkMode::LinkOnly,
    ...
    ScenarioSpec {
        ...
        ground_truth:   "data/benchmarks/brp_sis/link/ground_truth.csv",
        mode:           LinkMode::LinkOnly,
    ...
    ScenarioSpec {
        ...
        ground_truth:   "data/benchmarks/brp_hks/link/ground_truth.csv",
        mode:           LinkMode::LinkOnly,
    ...
    ScenarioSpec {
        ...
        sources:        &[
            ...
            SourceSpec { path: "data/benchmarks/brp_kvk_hks/link_and_dedupe/source_hks.csv", source: "hks" },
        ],
        ground_truth:   "data/benchmarks/brp_kvk_hks/link_and_dedupe/ground_truth.csv",
        mode:           LinkMode::LinkAndDedupe,
    ...
    ScenarioSpec {
        ...
        sources:        &[SourceSpec { path: "data/benchmarks/kvk/dedupe/source.csv", source: "kvk" }],
        ground_truth:   "data/benchmarks/kvk/dedupe/ground_truth.csv",
        mode:           LinkMode::Deduplicate,
        field_mappings: &[],
    ...
    ScenarioSpec {
        ...
        sources:        &[SourceSpec { path: "data/benchmarks/micro/brp/dedupe/source.csv", source: "brp" }],
        ground_truth:   "data/benchmarks/micro/brp/dedupe/ground_truth.csv",
        mode:           LinkMode::Deduplicate,
        field_mappings: &[],
    ...
    ScenarioSpec {
        ...
        sources:        &[
            SourceSpec { path: "data/benchmarks/micro/brp/link/source_a.csv", source: "brp_a" },
            SourceSpec { path: "data/benchmarks/micro/brp/link/source_b.csv", source: "brp_b" },
        ],
        ground_truth:   "data/benchmarks/micro/brp/link/ground_truth.csv",
        mode:           LinkMode::LinkOnly,
        field_mappings: &[],
    ...
    ScenarioSpec {
        ...
        sources:        &[
            SourceSpec { path: "data/benchmarks/micro/brp/link_and_dedupe/source_a.csv", source: "brp_a" },
            SourceSpec { path: "data/benchmarks/micro/brp/link_and_dedupe/source_b.csv", source: "brp_b" },
        ],
        ground_truth:   "data/benchmarks/micro/brp/link_and_dedupe/ground_truth.csv",
        mode:           LinkMode::LinkAndDedupe,
        field_mappings: &[],
    ...
    ScenarioSpec {
        ...
        ground_truth:   "data/benchmarks/micro/brp_sis/link/ground_truth.csv",
        mode:           LinkMode::LinkOnly,
        field_mappings: BRP_SIS_MAPPINGS,

...
mod tests {
    ...
    fn anyvalue_bool_roundtrip() {
        assert_eq!(anyvalue_to_field_value(AnyValue::Boolean(true)),  FieldValue::Bool(true));
        assert_eq!(anyvalue_to_field_value(AnyValue::Boolean(false)), FieldValue::Bool(false));
    }

    #[test]
    fn anyvalue_integer_widening() {
        assert_eq!(anyvalue_to_field_value(AnyValue::Int8(1)),    FieldValue::Int(1));
        assert_eq!(anyvalue_to_field_value(AnyValue::Int16(2)),   FieldValue::Int(2));
        assert_eq!(anyvalue_to_field_value(AnyValue::Int32(3)),   FieldValue::Int(3));
        assert_eq!(anyvalue_to_field_value(AnyValue::Int64(-99)), FieldValue::Int(-99));
        assert_eq!(anyvalue_to_field_value(AnyValue::UInt8(4)),   FieldValue::Int(4));
        assert_eq!(anyvalue_to_field_value(AnyValue::UInt16(5)),  FieldValue::Int(5));
        assert_eq!(anyvalue_to_field_value(AnyValue::UInt32(6)),  FieldValue::Int(6));
    ...
    fn anyvalue_float_widening() {
        assert_eq!(anyvalue_to_field_value(AnyValue::Float32(1.5)),  FieldValue::Float(1.5f32 as f64));
        assert_eq!(anyvalue_to_field_value(AnyValue::Float64(2.25)), FieldValue::Float(2.25));
    }
